...
from .views import SchoolAPIView, ClassAPIView, SubjectAPIView, TeacherAPIView, StudentListAPIView, ClassSearchAPIView, SubjectUpdateAPIView, SchoolUpdateAPIView, ClassUpdateAPIView, StudentListUpdateAPIView,  TeacherUpdateAPIView, SearchAPIView
